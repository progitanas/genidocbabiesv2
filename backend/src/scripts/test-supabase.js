...
async function testConnection() {
  ...
  try {
    ...
    console.log('\n📋 Next Steps:');
    console.log('1. Go to: https://app.supabase.com/project/yprqmqgopfqwvvmlanri/sql/new');
    console.log('2. Click "New Query" button');
    console.log('3. Paste the entire content of: backend/database/supabase-schema.sql');
