...
const BACKEND_API_URL = 'https://yprqmqgopfqwvvmlanri.supabase.co'; // Supabase API
...
const api = {
  ...
  admin: {
    ...
    step3: () =>
      apiFetch('/api/admin/onboarding/step3', { method: 'POST' }),
  ...
  pediatre: {
    ...
    step3: () =>
      apiFetch('/api/pediatre/onboarding/step3', { method: 'POST' }),
  ...
  tuteur: {
    ...
    step3: () =>
      apiFetch('/api/tuteur/onboarding/step3', { method: 'POST' }),
